...
print ("Ingrese su Nombre a continuacion: ")
nombre = str(input())
print ("Ingrese su Apellido a continuacion: ")
apellido = str(input())
print ("Ingrese su DNI a continuacion: ")
dni = int(input())
print ("Ingrese su edad a continuacion: ")
edad = int(input())
print ("Ingrese su altura a continuacion: ")
altura = float(input())
